    ...
    with tempfile.TemporaryDirectory(prefix="rocket_overlay_") as tmpdir:
        ...
        while True:
            ...
            if telemetry_t < 0 or telemetry_t > assets.t_end + 0.5:
                p, f = 0.0, 0.0
            compose = {"b": compose_frame_b, "c": compose_frame_c}.get(cfg.template, compose_frame)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--template", default="a", choices=("a", "b", "c"),
                   help="a = gauges + bottom band, b = bar meters + strip chart, c = shared-timeline 'Rangeline'.")
